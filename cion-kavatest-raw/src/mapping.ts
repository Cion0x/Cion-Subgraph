...
export function handleStakeCion(event: rewardRouter.StakeCion): void {
  let entity = new StakeCion(event.transaction.hash.toHexString())
...
export function handleUnstakeCion(event: rewardRouter.UnstakeCion): void {
  let entity = new UnstakeCion(event.transaction.hash.toHexString())
